...
Public archived-page evaluation uses sanitized feature-only manifests: raw HTML/JavaScript is not
retained or executed, browser/network behavior and dynamic DOM changes are not observed, redirects
